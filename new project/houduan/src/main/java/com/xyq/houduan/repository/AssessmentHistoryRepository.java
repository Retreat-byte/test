...
public interface AssessmentHistoryRepository extends JpaRepository<AssessmentHistory, Long> {
    ...
    List<AssessmentHistory> findByUserIdAndTypeAndDeletedFalseOrderByDateDesc(
        Long userId, AssessmentHistory.AssessmentType type);
    ...
    List<AssessmentHistory> findByUserIdAndTypeAndDateBetweenAndDeletedFalseOrderByDateDesc(
        Long userId, AssessmentHistory.AssessmentType type, LocalDate startDate, LocalDate endDate);
    ...
    long countByUserIdAndType(@Param("userId") Long userId, @Param("type") AssessmentHistory.AssessmentType type);
    ...
    Double getAverageScoreByUserIdAndType(@Param("userId") Long userId, @Param("type") AssessmentHistory.AssessmentType type);
    ...
    AssessmentHistory findLatestAssessmentRecordByType(@Param("userId") Long userId, 
                                                      @Param("type") AssessmentHistory.AssessmentType type);
    ...
    Page<AssessmentHistory> findByUserIdAndTypeAndDateBetweenAndDeletedFalseOrderByDateDesc(
        Long userId, AssessmentHistory.AssessmentType type, LocalDate startDate, LocalDate endDate, Pageable pageable);
    ...
    Page<AssessmentHistory> findByUserIdAndTypeAndDeletedFalseOrderByDateDesc(
        Long userId, AssessmentHistory.AssessmentType type, Pageable pageable);
