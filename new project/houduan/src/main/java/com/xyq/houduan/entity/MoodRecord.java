...
@Table(name = "mood_records", 
    indexes = {
        @Index(name = "idx_mood_user_id", columnList = "userId"),
        @Index(name = "idx_mood_date", columnList = "date"),
        @Index(name = "idx_mood_type", columnList = "mood"),
        @Index(name = "idx_mood_value", columnList = "`value`"),
        @Index(name = "idx_mood_deleted", columnList = "deleted")
    },
    uniqueConstraints = {
