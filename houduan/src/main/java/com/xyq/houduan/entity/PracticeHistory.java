...
@Table(name = "practice_history",
    indexes = {
        @Index(name = "idx_practice_user_id", columnList = "userId"),
        @Index(name = "idx_practice_type", columnList = "type"),
        @Index(name = "idx_practice_date", columnList = "date"),
        @Index(name = "idx_practice_duration", columnList = "duration"),
        @Index(name = "idx_practice_deleted", columnList = "deleted")
    }
)
