...
@Table(name = "assessment_history",
    indexes = {
        @Index(name = "idx_assessment_user_id", columnList = "userId"),
        @Index(name = "idx_assessment_type", columnList = "type"),
        @Index(name = "idx_assessment_date", columnList = "date"),
        @Index(name = "idx_assessment_score", columnList = "score"),
        @Index(name = "idx_assessment_deleted", columnList = "deleted")
    }
)
...
public class AssessmentHistory extends BaseEntity {
    ...
    public enum AssessmentType {
        ...
        /**
         * JSON反序列化时根据code值创建枚举
         */
        @JsonCreator
        public static AssessmentType fromCodeValue(String code) {
